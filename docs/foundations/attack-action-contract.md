...
Removing this patch restores Carpet 1.4.194 behavior without data migration.
The component call deliberately avoids the real-client load acknowledgement,
which a newly spawned fake player cannot provide.
